...
```javascript dark
https://www.emea-api.morningstar.com/ecint/v1/xray/json?languageId={{languageId}}&portfolioDataPoints={{portfolioDataPoints}}&benchmarkDataPoints={{benchmarkDataPoints}}
