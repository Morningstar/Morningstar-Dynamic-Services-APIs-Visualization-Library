...
The Risk Statistics component illustrates variations in a portfolio's returns for 1, 3, and 5 years based on a number of different ratios including Sharep Ration, Information Ration, Upside and Downside Capture Ratios.
