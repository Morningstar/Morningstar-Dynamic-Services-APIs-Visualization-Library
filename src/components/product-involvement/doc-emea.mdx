...
<Canvas withSource="open" withToolbar>
  <Story id="components-product-involvement--story-details"></Story>
</Canvas>
...
```javascript dark
"https://www.emea-api.morningstar.com.morningstar.com/portfolioanalysis/v1/esg?langcult={{languageId}}"
